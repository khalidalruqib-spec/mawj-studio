...
function resolvePreviewLayerShadow(
  layer: Pick<TimelineLayer, "shadowColor" | "shadowBlur" | "shadowOffsetX" | "shadowOffsetY">,
  scale: number,
) {
  ...
  return `${offsetX}px ${offsetY}px ${blur}px ${layer.shadowColor ?? "rgba(0,0,0,0.45)"}`;
}
